 ...
 *
 */
void CPiCam::cli_display_help(const COMMAND_LIST *commands, const int num_commands)
{
	int i;
 ...
 *
 */
int CPiCam::cli_get_command_id(const COMMAND_LIST *commands, const int num_commands, const char *arg, int *num_parameters)
{
	int command_id = -1;
	int j;
 ...
 */
int CPiCam::cli_map_xref(const char *str, const XREF_T *map, int num_refs)
{
   int i;
 ...
 */
const char *CPiCam::cli_unmap_xref(const int en, XREF_T *map, int num_refs)
{
   int i;
