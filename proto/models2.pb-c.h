...
#ifndef PROTOBUF_C_proto_2fmodels2_2eproto__INCLUDED
#define PROTOBUF_C_proto_2fmodels2_2eproto__INCLUDED
...
typedef struct _FCWS__Position FCWS__Position;
...
typedef enum _FCWS__Position__Type {
  FCWS__POSITION__TYPE__UnKonwn = -1,
  FCWS__POSITION__TYPE__LEFT = 0,
  FCWS__POSITION__TYPE__RIGHT = 1,
  FCWS__POSITION__TYPE__TOP = 2,
  FCWS__POSITION__TYPE__TOTAL = 3
    PROTOBUF_C__FORCE_ENUM_TO_BE_INT_SIZE(FCWS__POSITION__TYPE)
...
struct  _FCWS__Position
{
  ProtobufCMessage base;
  FCWS__Position__Type pos;
  size_t n_para;
  FCWS__Para **para;
};
#define FCWS__POSITION__INIT \
 { PROTOBUF_C_MESSAGE_INIT (&fcws__position__descriptor) \
    , FCWS__POSITION__TYPE__UnKonwn, 0,NULL }
...
typedef void (*FCWS__Para_Closure)
                 (const FCWS__Para *message,
                  void *closure_data);
typedef void (*FCWS__Position_Closure)
                 (const FCWS__Position *message,
                  void *closure_data);
...
extern const ProtobufCMessageDescriptor fcws__position__descriptor;
extern const ProtobufCEnumDescriptor    fcws__position__type__descriptor;
...
#endif  /* PROTOBUF_C_proto_2fmodels2_2eproto__INCLUDED */
