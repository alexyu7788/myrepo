...
#define FFMPEG_CONFIGURATION "--extra-ldflags='-L/usr/local/lib -lgsl -lgslcblas -lstdc++' --extra-cflags=-I/usr/local/include --cc=gcc --cxx=g++ --extra-cxxflags='-std=gnu++11'"
#define FFMPEG_LICENSE "LGPL version 2.1 or later"
#define CONFIG_THIS_YEAR 2018
#define FFMPEG_DATADIR "/usr/local/share/ffmpeg"
#define AVCONV_DATADIR "/usr/local/share/ffmpeg"
#define CC_IDENT "gcc 4.9.2 (Debian 4.9.2-10+deb8u1)"
