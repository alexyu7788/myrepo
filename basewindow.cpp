...
CBaseWindow::CBaseWindow(std::string titlename, std::string yuv_folder, int width, int height): 
m_terminate(false),
m_quit(false),
...
//void CBaseWindow::UpdateDrawInfo(Candidates &vcs)
//{
//    int i;
//    int r, c, w, h;
//    CandidatesIt it;
...
void CBaseWindow::ProcessKeyEvent()
{
    if (m_event == NULL)
        return;
...
void CBaseWindow::ProcessMouseEvent()
{
//    for (int i=0 ; i<SELECTOR_TOTAL ; i++)
//    {
//        if (m_selector[i])
...
//void CBaseWindow::DrawShiftWindow()
//{
...
void CBaseWindow::CreateOutputFolder()
{
    char cmd[256] = {'\0'};
...
void CBaseWindow::SaveFeatureYUV()
{
    int need_sync = 0;
